...
export default function SidebarAdmin(props) {
    ...
    return (
        <div className={`fixed px-5 py-5 ${props.data.open? `w-60`:`w-20`} duration-300 h-full text-white bg-black z-20`}>
            <div className='flex flex-col h-full'>
                ...
                <button className={`absolute flex -right-3 mt-7 bg-white rounded-full`} onClick={()=>props.data.setOpen(!props.data.open)}>
